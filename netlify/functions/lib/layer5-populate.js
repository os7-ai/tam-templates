...
const MAIN_LINE_CODE_MAP = {
  ...
  'مصروفات عمومية وإدارية': 'GE', // نفس مفهوم GE بصياغة عميل مختلفة (اختبار 2) — إضافة ميكانيكية، لا حكم منطقي جديد
  ...
  'التسويق والإعلان': 'SE', // مصاريف بيعية وتسويقية — أول استخدام فعلي لكود SE (اختبار 2)
  // 'الرواتب ومصروفات الموظفين ذات العلاقة' (اختبار 2): بلا كود مطابق بين الثمانية
  // الثابتة (CS/GE/SE/FIN/DEP/LOS/PROV/OTH) — عمداً غير مُضاف هنا. هذا قرار معلّق
  // بانتظار تأكيد المستخدم، وليس فجوة كود يمكن حلّها بشكل حيادي.
};
